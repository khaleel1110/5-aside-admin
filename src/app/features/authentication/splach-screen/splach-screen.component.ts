  ...
  template: `
    <div class="w-100 d-flex justify-content-center vh-100">
      <div class="d-flex flex-column justify-content-center gap-2">
        <div class="mb-0">
          <img style="height: 15rem; object-fit: cover "src="/assets/5-asilde/logo/my-logo.png">
        ...
        <div class='  justify-content-center  text-center '>
          <p class='text-lg mb-0'>AA Gwarzo Sports Arena Admin Panel </p>
          <p class='text-sm form-select-sm mt-0'>Powered by Sports Arena.</p>
        </div>
      </div>
